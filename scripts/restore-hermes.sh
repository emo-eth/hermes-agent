...
cat >"$report" <<EOF
{
  ...
  "backup_audit_missing_jsonl_count": "${backup_audit_missing_jsonl:-0}",
  "backup_audit_extra_jsonl_count": "${backup_audit_extra_jsonl:-0}",
  "backup_audit_missing_sessions_json_entries": "${backup_audit_missing_index:-0}",
  "backup_audit_extra_sessions_json_entries": "${backup_audit_extra_index:-0}",
  "backup_audit_jsonl_message_drift_count": "${backup_audit_message_drift:-0}",
  "backup_audit_live_jsonl_message_mismatch_count": "${backup_audit_live_jsonl_mismatch:-0}",
  "backup_audit_live_state_sessions_without_legacy_files": "${backup_audit_live_state_legacy_gaps:-0}",
  "backup_audit_live_message_sessions_without_jsonl": "${backup_audit_live_message_without_jsonl:-0}",
  "backup_state_db_size_bytes": "${backup_audit_backup_state_db_size:-0}",
